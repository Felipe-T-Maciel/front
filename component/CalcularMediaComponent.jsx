            ...
            <div className="relative left-auto flex-col flex justify-around items-center top-auto rounded-xl w-[926px] h-[609px] bg-[#0C62A0]">
                ...
                <div className="flex justify-center items-center">
                    ...
                    <div className="flex flex-col justify-between">
                        ...
                        <div className=" flex justify-between items-center mb-8">
                            <label htmlFor="" className="text-white mr-4 text-2xl">Nota</label>
                            <input className="rounded-xl w-[230px] h-[40px]" name="" id="">

                            </input>
                        </div>
                    </div>
                </div>
                <div className=" rounded-2xl w-[590px] h-[240px] bg-slate-50">
